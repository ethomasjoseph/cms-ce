Ext.define( 'Lib.plugins.fileupload.PhotoUploadButton', {
    ...
    tpl : new Ext.XTemplate( '<div id="{id}" class="cms-image-upload-button-container" style="width:{width - 9}px;height:{height - 9}px; margin: 6px">' +
